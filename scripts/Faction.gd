...
var faction_type: String = "territorial"  # "territorial" / "network" / "lair"
...
var lair_region_id: int = -1        # jen pro faction_type == "lair": ID regionu
var faction_display_name: String = ""  # unikátní jméno např. "Kult Věčné Tmy"
var founder_name: String = ""          # jméno agenta který org založil
